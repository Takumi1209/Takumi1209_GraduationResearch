...
%% 指導教員名（姓名＋職位、指導教員の職位が「教授」なのか「准教授」なのかは学科のWebサイトで確認できる）
\supervisor{後藤 祐一 准教授}

%% 研究室の所属部署。よくわからないならこのまま
\labaffiliation{埼玉大学 理工学研究科・工学部}

%% 研究室名
\labname{先端情報システム工学研究室}
...
% 謝辞は自由に書いてよいことになっている。以下は参考例。
研究ならびに生活面においてご指導いただきました後藤祐一准教授に深く感謝いた
します．

また，実験などに協力いただいた研究室の皆様，そして同期学生の皆様，並びに私を暖かく見守って頂いた両親はじめとする周囲のすべての皆様に深く感謝いたします．
...
\setcounter{page}{1}   %消さないこと
 ...
 \section{背景}
 　日本で TOEIC(R) Program を実施・運営する国際ビジネスコミュニケーション協会の調査※によると、英語で話すことを苦手と感じる人の理由として、「自身の英語力に自信がない」という回答が最も多かった。 \par
 　自身の英語力に自信がないため、「英語を話したくない」という人が半数以上であった。
 　英語でのコミュニケーションにおいて外国人と意思疎通をはかるために重要だと考えていることは、「伝えたい気持ち」が最も多く挙げられた。\par
 　グローバル社会において英会話ができないことは機会損失につながる。\par
 　英会話が上手くなるためにはネイティブに対して臆することなく、英語を話せるようにすることが不可欠である。 \par
 　ネイティブとの英会話の前段階における英会話練習において、自信を持って積極的に英語を話せる機会を設けなければならない。 \par
...
\chapter{関連研究} \label{chap:exp}
 \section{プロテウス効果} \label{sec:method}

 \section{鏡像認知}

\chapter{web会議ツール上で英会話練習する際にアバターを使用することでユーザに及ぼす影響の調査実験} \label{chap:exp}
 \section{実験環境} \label{sec:method}
...
\chapter{実験結果} \label{chap:exp}
 \section{主観的評価} \label{sec:method}
 実験方法

 \section{客観的評価}
 実験結果

\chapter{考察とまとめ} \label{chap:exp}

\chapter{今後の課題} \label{chap:exp}
 \section{実験方法の課題} \label{sec:method}
